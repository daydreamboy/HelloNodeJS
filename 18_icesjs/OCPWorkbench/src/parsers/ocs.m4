syscmd(`cat ../ocs_components/01_ocs_utility_function.pegjs')

start = remote_lib / js_lib / body

syscmd(`cat ../ocs_components/09_ocs_remotelib_jslib.pegjs')

syscmd(`cat ../ocs_components/07_ocs_group.pegjs')

syscmd(`cat ../ocs_components/08_ocs_body_expression_p1.pegjs')
